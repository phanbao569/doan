    ...
    <div>
     ...
     <div className="flex  flex-row justify-around">
         ...
         <div className="flex w-2/3  py-10">
           ...
           <button  
           onClick={handleFilterSubmit} type="button" ><IoIosSearch size={32} /></button>
       ...
       <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-500">
         <thead className="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-600">
           <tr>
             ...
             <th scope="col" className="px-6 py-3 w-1/6">
             <Link to={`/createmanager`} className='mt-10 '  >
     <button type="button"
             ...
             <tr key={index} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
               ...
               <td className="px-6 py-4 flex items-center">
                 ...
                 <div className="flex items-center space-x-3.5">
                   <Link  to={`/xem-user/${item.idUser}`} className="text-primary">
