    ...
    return (
        <div className="min-h-screen font-fontgg ">
            ...
            <form className="w-[1100px] bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 m-auto">
                ...
                <div>
                    <h1 className='font-bold text-center bg-orange-300 p-3 rounded mb-3'>Thông tin đề nghị đăng ký tạm vắng</h1>
                ...
                <div className='flex justify-between gap-3'>
                    <div className="mb-6 flex-1">
                        ...
                        <textarea value={form?.lyDoTamVang} className="w-full bg-white whitespace-pre-wrap text-gray-700 border rounded py-2 px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" readOnly />
                    </div>
                    <div className="mb-6">
