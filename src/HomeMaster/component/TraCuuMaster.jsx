...
export default function TraCuuM() {
  ...
  const [showDanhSach, setShowDanhSach] = useState(true);
    ...
    <div className=''>
      ...
      <div className='w-full h-screen mt-6'>
        ...
        {showDanhSach && (
          // <div>
          //   {danhSach ? (
          //     <div className='mt-12 ml-32 p-2'>
          //       {danhSach.giaHanTamTrus.map((item, index) => (
          //         <div key={index} className="my-4">
          //           <p className='ml-28 block text-lg hover:text-red-700'>Tên thủ tục: {item.tenThuTuc}</p>
          //           <div className='flex ml-28 text-sm gap-4'>
          //             <div className='flex items-center gap-1'>
          //               <MdOutlineDateRange />
          //               Ngày tạo: {item.created_at} {/* I assume 'created_at' exists in your data */}
          //             </div>
          //             <div className='flex items-center gap-1'>
          //               <TbBrandOnedrive />
          //               Tình trạng: {item.trangThai} {/* I assume 'trangThai' exists in your data */}
          //             </div>
          //           </div>
          //         </div>
          //       ))}
          ...
          //   )}
          // </div>
          <table className="w-880 min-w-[800px] table-auto">
            <thead>
            ...
            <tbody>
        {/* {packageData.map((packagiteItem, key) => (
          <tr key={key}>
